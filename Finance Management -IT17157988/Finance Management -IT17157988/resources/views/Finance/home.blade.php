        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <a href="Finance/Sindex"><h3>Student and Parent Management System </h3></a>
                </div>
                <div class="col-md-3">
                    <div class="abc">
                        <img alt="" width="100%" src="{{asset('images/2-1.jpg')}}" /></div>
                    <a href="Finance/Eventindex"><h3>Event Management System </h3></a>
                </div>
                <div class="col-md-3">
                    <div class="abc">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <a href="Finance/Lindex"><h3>Library Management System </h3></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <a href="Finance/Inventoryindex"><h3>Inventory Management System </h3></a>
                </div>
                <div class="col-md-3">
                    <div class="abc">
            ...
            <div class="row">
                ...
                <div class="abc">
                    <img alt="" width="100%" src="{{asset('images/MReport.jpg')}}" /></div>
                <a href="MonthlyReportGeneration"><h3>Monthly Report Generation </h3></a>
            </div>
            <div class="col-md-3">
                <div class="abc">
                    <img alt="" width="100%" src="{{asset('images/AnnualReport.jpg')}}" /></div>
                <a href="AnnualReportGenearation"><h3>Annual Report Generation </h3></a>
            </div>
